...
- **Comprehensive Outputs:** 12 high-resolution charts (300 DPI), 10 analytical tables (CSV/Excel), and 6 normalized datasets ready for Power BI integration.
...
uk-nonstore-retail-analytics/
 ...
 │
 ├── 01_Raw_Data/                     # 6 normalized datasets ready for Power BI
 │
 ...
 │
 ├── 04_Outputs/
 │   ├── Charts/                      # 12 Generated visualizations (PNG/PDF)
 │   ├── Reports/                     # Generated reports (DOCX/PDF/PPTX)
...
4. Review executive summary in `05_Documentation/final_summary.md`
...
- **🔴 HIGH PRIORITY (30 Days):** Protect UK Champions, launch Win-Back Campaign for At Risk customers (~£690K impact), and manage dead stock.
- **🟡 MEDIUM PRIORITY (90 Days):** Dual-track seasonal inventory planning, international diversification, and separate Product vs. Operational revenue in dashboards.
- **🟢 LONG-TERM (6-12 Months):** Guest-to-registered conversion and upselling Loyal Customers. Target: Reduce UK revenue share from 84.6% to <70% within 2 years.

## 🛠️ Methodology & Technology Stack
- **Data Quality Decisions:** Missing CustomerID labeled "Unknown" (excluded from RFM), exact duplicates removed, extreme outliers isolated, operational items excluded from product rankings.
- **Analytical Framework:** Evidence → Decision → Action → Validation.
- **Technology Stack:** Python 3.12, `pandas`, `numpy`, `matplotlib`, `seaborn`, Jupyter Notebook.

## 📈 Project Evolution
- **v1.0 — Initial Portfolio Release (September 2026):** Complete analytical workflow, evidence-based decision making, professional documentation, 12 high-res charts, 10 analytical tables, and 6 Power BI-ready data splits.
- **Planned v1.1 — Data & Logic Corrections:** Refine outlier handling logic, improve revenue reconciliation, enhance visualization consistency.
- **Planned v2.0 — Professionalization & Optimization:** Performance optimization, code refactoring, advanced analytics (CLV, Cohort Analysis, Market Basket).

## 📚 Documentation
- **Main Analysis:** `03_Notebooks/01_Online_Retail_Analysis.ipynb`
- **Executive Summary:** `05_Documentation/final_summary.md`
